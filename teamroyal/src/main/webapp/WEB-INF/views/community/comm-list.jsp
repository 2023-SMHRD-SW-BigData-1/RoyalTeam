        ...
        <div id="board-list">
            <div class="container" style="border: 1px solid red;">
                <table class="board-table">
                    <thead>
                        <tr>
                            <th scope="col" class="th-num" style="border: 1px solid red;">번호</th>
                            <th scope="col" class="th-title" style="border: 1px solid red;">제목</th>
                            <th scope="col" class="th-ctt" style="border: 1px solid red;">글쓴이</th>
                            <th scope="col" class="th-ctt" style="border: 1px solid red;">채팅</th>
                            <th scope="col" class="th-ctt" style="border: 1px solid red;">이메일</th>
                            <th scope="col" class="th-ctt" style="border: 1px solid red;">날짜</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
