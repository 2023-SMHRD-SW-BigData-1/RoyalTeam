						...
						<div class="row">
																	...
																	<form id="formAuthentication" class="mb-3"
																		...
																		<div class="mb-3">
																			<label for="username" class="form-label">발전소
																				...
																				placeholder="발전소 주소를 입력하세요" autofocus />
																		</div>
																		<div class="mb-3">
																			<label for="username" class="form-label">발전소
																		...
																		<button class="btn btn-primary d-grid w-100">발전소등록</button>
																	</form>
																</div>
															</div>
															<!-- /Forgot Password -->
							...
							<div class="col-12">
								...
								<div class="card">
									<div class="card-body ">
										<div class="d-flex">
											<h4 class="card-text text-uppercase w-25">USER</h4>
										...
										<div class="d-flex">
											<ul class="list-unstyled mb-4 mt-3 w-25 d-flex flex-column">
												<li class="d-flex align-items-center mb-3"><i
													...
													class="fw-medium mx-2 text-heading">닉네임: </span><span>박충희</span>
												</li>
												<li class="d-flex align-items-center mb-3"><i
													class="ti ti-mail"></i><span
													class="fw-medium mx-2 text-heading">Email:</span> <span>Shine@example.com</span>
												</li>
												<li class="d-flex align-items-center mb-3"><i
