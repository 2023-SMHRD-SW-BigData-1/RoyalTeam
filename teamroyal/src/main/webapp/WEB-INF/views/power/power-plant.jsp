...
<style>
.highcharts-title, .highcharts-subtitle, .highcharts-caption {
	display: none;
}
</style>
							...
							<div class="col-12 ">
								<div class="card mb-4 m-auto p-3">
									<button type="button" class="btn btn-primary w-10"
										...
										<i class="ti ti-check me-1" style="font-size: .7rem;"></i>발전소
										등록
									</button>
													...
													<div
														...
														<div class="authentication-inner py-4">
															...
															<div class="card">
																<div class="card-body">
																	<div class="mb-3">
																		<label for="username" class="form-label">발전소
																			주소</label> <input type="text" class="form-control" id="ppAdd"
																			name="username" placeholder="발전소 주소를 입력하세요" autofocus />
																	</div>
																	<div class="mb-3">
																		<label for="username" class="form-label">발전소
																			고유번호</label> <input type="text" class="form-control"
																			id="ppNum" name="username"
																			placeholder="발전소 고유번호를 입력하세요" autofocus />
																	</div>
									...
									<div
										class="user-profile-header d-flex justify-content-between w-100">
										<div class="p-3 w-50">
											...
											<ul class="list-unstyled d-flex justify-content-between">
												<li class="d-flex align-items-center ">
													...
													<div>
														...
														<small class="text-muted mx-2" id="allgener"></small>
													</div>
												</li>
												<li class="d-flex align-items-center ">
													...
													<div>
														...
														<small class="text-muted mx-2" id="premodal"></small>
													</div>
												</li>
												<li class="d-flex  align-items-center ">
													<div class="badge rounded bg-label-warning p-1">
													...
													<div>
														...
														<small class="text-muted mx-2" id="smp_data"></small>
													</div>
												</li>
												<li>
												<li class="d-flex  align-items-center ">
													...
													<div>
														...
														<small class="text-muted mx-2" id="rec_data"></small>
													</div>
												</li>
												</li>
											</ul>
										...
										<div class="card-body pb-0">
											<ul class="timeline ms-1 mb-0">
												...
												<li
													class="timeline-item timeline-item-transparent border-transparent">
										...
										<div class="d-flex">
											<ul class="list-unstyled mb-4 mt-3 w-25 d-flex flex-column">
												<li class="d-flex align-items-center mb-3"><i
													...
													class="fw-medium mx-2 text-heading">닉네임: </span><span>${user.userNick }</span>
												</li>
												<li class="d-flex align-items-center mb-3"><i
													class="ti ti-mail"></i><span
													class="fw-medium mx-2 text-heading">Email:</span> <span>${user.userEmail }</span>
												</li>
												<li class="d-flex align-items-center mb-3"><i
													class="ti ti-flag text-heading"></i><span
													class="fw-medium mx-2 text-heading">발전소 주소:</span> <span>광주광역시</span>
												</li>
												<li class="d-flex align-items-center mb-3"><i
													class="ti ti-phone-call"></i> <span
													class="fw-medium mx-2 text-heading">발전소 고유번호:</span> <span>110-153-2518554</span>
												</li>
											</ul>
											...
											<ul class="list-unstyled mb-4 mt-3 w-20">
												<li class="d-flex align-items-center mb-3 w-100 ">
													...
													<div>
														<h6 class="mb-0 mx-2 text-nowrap">현재 발전량(Kw)</h6>
														<small class="text-muted mx-2" id="nowpower"></small>
													</div>
												</li>
												<li class="d-flex align-items-center mb-3 w-100">
													...
													<div>
														<h6 class="mb-0 mx-2 text-nowrap">발전시간</h6>
														<small class="text-muted mx-2" id="genertime"></small>
													</div>
												</li>
												<li class="d-flex  align-items-center mb-3 w-100">
													<div class="badge rounded bg-label-warning">
													...
													<div>
														<h6 class="mb-0 mx-2 text-nowrap">예측 발전량</h6>
														<small class="text-muted mx-2" id="generperspre"></small>
													</div>
												</li>
												<li class="d-flex  align-items-center w-100">
													...
													<div>
														<h6 class="mb-0 mx-2 text-nowrap">예측 수익</h6>
														<small class="text-muted mx-2" id="pregain"></small>
													</div>
												</li>
											</ul>
											<ul class="list-unstyled mb-4 mt-3 w-50 ">
												<li class="d-flex align-items-center mb-3">
													<div id="sh-symbols-per"
