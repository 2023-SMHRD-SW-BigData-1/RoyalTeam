          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbar-ex-5">
              <div class="navbar-nav me-auto">
                ...
                <a class="nav-item nav-link active" href="community.html">COMMUNITY</a>
                <a class="nav-item nav-link" href="chat.html">CHAT</a>
                <a class="nav-item nav-link" href="power-plant.html">POWER PLANT</a>
              </div>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="col-lg-10 mx-auto">
                <ul class="row list-unstyled">
                  ...
                  <li class="col-md-2-5 mb-md-0 mb-4 mt-3 sh-test">
                    ...
                    <div class="card border shadow-none">
                      <div class="card-body text-start p-0">
                        <div class="w-100" >
                          <img src="/assets/img/avatars/1.png" class="w-100 "  alt="">
                        </div>
                        <div class="mx-2">
                  ...
                  <li class="col-md-2-5 mb-md-0 mb-4 mt-3 sh-test2">
                    <a href="auction-detail.html">
                    <div class="card border shadow-none">
                      <div class="card-body text-start p-0">
                        <div class="w-100" >
                  ...
                  <li class="col-md-2-5 mb-md-0 mb-4 mt-3">
                    <a href="auction-detail.html">
                    <div class="card border shadow-none">
                      <div class="card-body text-start p-0">
                        <div class="w-100" >
