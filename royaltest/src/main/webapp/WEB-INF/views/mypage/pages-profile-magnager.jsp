							...
							<div class="card">
								...
								<div class="offcanvas offcanvas-end" tabindex="-1"
									...
									<div class="offcanvas-header">
										<h5 id="offcanvasAddUserLabel" class="offcanvas-title">Add
											User</h5>
										...
										<form class="add-new-user pt-0" id="addNewUserForm"
											...
											<div class="mb-3">
												<label class="form-label" for="add-user-fullname">Full
													...
													id="add-user-fullname" placeholder="John Doe"
											...
											<div class="mb-3">
												...
												<input type="text" id="add-user-company"
													class="form-control" placeholder="Web Developer"
											...
											<div class="mb-4">
												<label class="form-label" for="user-plan">Select
													Plan</label> <select id="user-plan" class="form-select">
