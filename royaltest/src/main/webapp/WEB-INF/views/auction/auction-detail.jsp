							...
							<div class="card-body row g-3">
								<div class="col-lg-12">
									...
									<div
										...
										<div class="d-flex">
											...
											<div class="d-flex flex-column">
												<span class="fw-medium">Devonne Wallbridge</span> <small
													class="text-muted">2023.10.17<span class="mx-2">17:50</span></small>
											</div>
										</div>
										<div class="d-flex align-items-center">
											<a href="chat.html"
												class="d-flex mx-2 btn btn-primary bg-transparent border-none btn-no-boxshadow">
									...
									<div class="card academy-content shadow-none border">
										...
										<div class="card-body">
											<h5>내용</h5>
											<p class="mb-4">The material of this course is also
												covered in my other course about web design and development
												with HTML5 & CSS3. Scroll to the bottom of this page to
												check out that course, too! If you're already taking my
												other course, you already have all it takes to start
												designing beautiful websites today!</p>
											<p class="mb-4">"Best web design course: If you're
												interested in web design, but want more than just a "how to
												use WordPress" course,I highly recommend this one." —
												Florian Giusti</p>
											<p>"Very helpful to us left-brained people: I am familiar
												with HTML, CSS, JQuery, and Twitter Bootstrap, but I needed
												instruction in web design. This course gave me practical,
												impactful techniques for making websites more beautiful and
												engaging." — Susan Darlene Cain</p>
											<hr class="mb-4 mt-2" />
											<h5 class="mb-2">댓글</h5>
											<hr class="mb-4 mt-2" />
											<!-- user info -->
												...
												<div class="d-flex w-100">
													...
													<div class="d-flex flex-column w-100">
														<div class="d-flex justify-content-between">
															<span class="fw-medium">${user}박충희</span> <span
																class="fw-medium">
																<button
											...
											<div class="border mt-5">
												...
												<textarea name="collapsible-address"
													class="form-control border-none" id="collapsible-address"
