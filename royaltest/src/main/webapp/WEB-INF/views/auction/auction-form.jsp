        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbar-ex-5">
            ...
            <ul class="navbar-nav ms-lg-auto">
              <li class="nav-item">
                <a class="nav-link" href="/html/mypage/pages-profile-userprofile.html"><i
              ...
              <li class="nav-item">
                <a class="nav-link" href="index.html"><i class="tf-icons navbar-icon ti ti-lock-open ti-xs me-1"></i>
                  Logout</a>
              </li>
            </ul>
          </div>
